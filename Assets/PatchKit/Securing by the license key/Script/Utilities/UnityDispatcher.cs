...
namespace PatchKit.SecuringByTheLicenseKey.Utilities
{
[AddComponentMenu("")]
public class UnityDispatcher : MonoBehaviour
{
    ...
    {
        return BaseInvoke(manualResetEvent =>
            _instance.StartCoroutine(CoroutineWithEventWaitHandle(coroutine, manualResetEvent)));
    }

    private static IEnumerator CoroutineWithEventWaitHandle(IEnumerator coroutine,
